...
#define HASHMAP_CREATE_STRING(value_type, value_name)                                                                  \
...
#define HASHMAP_SET_STRING(value_type, value_name)                                                                     \
...
#define HASHMAP_GET_STRING(value_type, value_name)                                                                     \
...
#define HASHMAP_GETP_STRING(value_type, value_name)                                                                    \
...
#define HASHMAP_HAS_STRING(value_type, value_name)                                                                     \
...
#define HASHMAP_REMOVE_STRING(value_type, value_name)                                                                  \
...
#define HASHMAP_DESTROY_STRING(value_type, value_name)                                                                 \
...
#define HASHMAP_DEFINE_STRING_TYPE(value_type, value_name)                                                             \
    ...
    HASHMAP_CREATE_STRING(value_type, value_name)                                                                      \
    HASHMAP_SET_STRING(value_type, value_name)                                                                         \
    HASHMAP_GET_STRING(value_type, value_name)                                                                         \
    HASHMAP_GETP_STRING(value_type, value_name)                                                                        \
    HASHMAP_HAS_STRING(value_type, value_name)                                                                         \
    HASHMAP_REMOVE_STRING(value_type, value_name)                                                                      \
    HASHMAP_DESTROY_STRING(value_type, value_name)
