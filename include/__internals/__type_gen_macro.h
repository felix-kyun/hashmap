...
#define HASHMAP_DEFINE_TYPE(key_type, key_name, value_type, value_name)                                                \
    ...
    static inline int hashmap_has_##key_name##_##value_name(hashmap_##key_name##_##value_name##_t* map, key_type key)  \
    {                                                                                                                  \
    ...
    static inline void hashmap_destroy_##key_name##_##value_name(hashmap_##key_name##_##value_name##_t* map)           \
    {                                                                                                                  \
